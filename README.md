...
[![CircleCI](https://circleci.com/gh/sisioh/baseunits-scala.svg?style=svg&circle-token=434850c0b6bedeed451a8aef2ec8a0274c256b9c)](https://circleci.com/gh/sisioh/baseunits-scala)
...
libraryDependencies += "org.sisioh" %% "baseunits-scala" % "0.1.22"
```
...
libraryDependencies += "org.sisioh" %% "baseunits-scala" % "0.1.23-SNAPSHOT"
```
